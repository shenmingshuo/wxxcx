...
├── 📄 wx-mini-game-demo-INTEGRATION.md  # 新集成游戏说明
│
├── 📄 package.json                 # 前端依赖配置
...
│   │   ├── TetrisGame.ts          # 俄罗斯方块
│   │   ├── ShooterGame.ts         # 空中射击
│   │   ├── FlappyBirdGame.ts      # Flappy Bird
│   │   ├── FishTankGame.ts        # 鱼群游戏 ⭐
│   │   ├── BitmapShooterGame.ts   # 位图射击 ⭐
│   │   └── BoidGame.ts            # 鸟群模拟 ⭐
│   │
│   ├── 📁 utils/                   # 工具类
...
### 1. 🎲 2048
经典数字合并游戏，滑动合并相同数字，挑战2048！

### 2. 🧱 俄罗斯方块
经典俄罗斯方块，支持手势操控，流畅体验。

### 3. ✈️ 空中射击
驾驶战机消灭敌人，4层视差背景，流畅射击体验。

### 4. 🐦 Flappy Bird
点击飞行，避开管道，挑战极限！完美还原经典玩法。
...
**注**: 目前所有游戏均为单机模式，联机功能框架已完成，可扩展添加。
...
| [wx-mini-game-demo-INTEGRATION.md](./wx-mini-game-demo-INTEGRATION.md) | 新集成3个游戏说明 ⭐ | 开发者 |
